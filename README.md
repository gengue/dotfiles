...
```bash
brew install git neovim zellij node go uv sqlite jq lazygit lazysql bat lsd mosh ripgrep libpng jpeg ncurses chafa graphviz graphicsmagick tree-sitter fzf ripgrep fd gh glab
